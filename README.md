...
Chave de API do Unsplash (para imagens)


🛠️ Como Rodar Localmente
1. Clone o repositório:
bashgit clone https://github.com/seu-usuario/seu-repo.git
cd seu-repo
2. Configure a chave da API do Unsplash:
Abra o arquivo services/unplash.php e insira sua chave:
phpdefine('UNSPLASH_ACCESS_KEY', 'sua_chave_aqui');
...
CampoTipoDescriçãoidintIdentificador único do posttitulostringTítulo do postdescricaostringDescrição/resumocategoriastringCategoria principaltagsarrayLista de tags relacionadas
...
bashmkdir cache && chmod 755 cache
